    ...
    <>
      ...
      <div className="layout-container py-8 md:py-12">
        <nav aria-label="パンくずリスト" className="mb-6 text-sm text-slate-500 flex flex-wrap gap-1 items-center">
          ...
          <span aria-hidden="true">›</span>
          <span className="text-slate-700 font-medium">トルエン</span>
        </nav>

        <div className="max-w-3xl">
          <p className="tag mb-3">有機溶剤</p>
          <h1 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">トルエン</h1>
          <p className="text-slate-600 text-lg mb-8">
            姫路市・播磨地域・兵庫県全域へ供給。大和薬品株式会社が取り扱う工業用・試薬用トルエンのご案内です。
          </p>
