...
export default function Collection() {
  ...
  const items = [
    ...
    },
    {
      ...
      comment: "ソフトバンクの前身、南海ホークスのキャップに付けていた、駄菓子屋さんで当てたバッジ。",
    },
    {
    ...
    },
    {
      ...
      comment: "金属製のシガレットケースで、昭和のリビングでは車種ごとのものがありました。",
    },
    {
      src: "/Collection/IMG_2492.jpeg",
      comment: "液晶画面が壊れているワープロで、当時は最先端の機械でした。",
    },
    {
      src: "/Collection/IMG_2493.jpeg",
      comment: "鹿の剥製で、大金持ちの家の応接室に置いてあった印象があります。",
    },
    {
      src: "/Collection/IMG_2494.jpeg",
      comment: "昭和時代の小学校の机と椅子と、子供のランドセルです。",
    },
  ];
