      ...
      <header className="bg-gray-100 border-b shadow-sm">
        <div className="max-w-7xl mx-auto flex justify-between items-center p-4">
          ...
          <div className="text-sm text-right">
            <p>
              TEL <span className="text-emerald-600 font-bold">079-281-0671</span>
            </p>
        ...
        <nav className="bg-emerald-700 text-white">
          <ul className="flex justify-center space-x-4 text-sm py-2">
            <li className="hover:bg-emerald-800 px-4 py-1">ホーム</li>
            <li className="hover:bg-emerald-800 px-4 py-1">主な取扱品目</li>
            <li className="hover:bg-emerald-800 px-4 py-1">アクセスマップ</li>
            <li className="hover:bg-emerald-800 px-4 py-1">会社概要</li>
            <li className="hover:bg-emerald-800 px-4 py-1">お問い合わせ</li>
          </ul>
        </nav>
      </header>
      ...
      <main className="max-w-7xl mx-auto p-6 grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <aside className="md:col-span-1 space-y-4">
          <div className="bg-emerald-100 p-4">
            <h2 className="text-emerald-800 font-bold">MENU</h2>
        ...
        <section className="md:col-span-3 space-y-6">
          <div>
            <h2 className="text-emerald-700 font-bold text-xl mb-2">ごあいさつ</h2>
          ...
          <div className="bg-emerald-50 p-4">
            <h3 className="font-bold text-emerald-700">製品に関するお問い合わせ</h3>
            <p className="text-sm">お気軽にお電話ください（平日8:00〜17:00）</p>
            <p className="text-lg text-emerald-700 font-bold mt-2">079-281-0671</p>
            <button className="mt-2 px-4 py-2 bg-emerald-700 text-white rounded">お問い合わせフォーム</button>
          </div>
        </section>
      </main>
