...
export const PAGE_SEO = {
  ...
  products: {
    title: "取扱製品｜メタノール・トルエン・エタノール・塩酸ほか｜姫路の化学薬品商社 大和薬品",
    description: "メタノール、トルエン、エタノール、塩酸、苛性ソーダ、次亜塩素酸ソーダなど160品目以上の化学薬品・工業薬品・有機溶剤・試薬を取り扱い。兵庫県姫路市から関西エリアへ迅速に供給。薬品名で検索可能。",
    ogImage: `${SITE_URL}/company-logo.png`,
    keywords: "メタノール,トルエン,エタノール,塩酸,苛性ソーダ,次亜塩素酸ソーダ,化学薬品,工業薬品,有機溶剤,試薬,姫路,兵庫,関西"
  },
  company: {
